...
>
  ...
  If you are new to the world of cryptocurrencies, you can check the following link, with basic concepts explained at <strong><a href="https://ethereum.org/en/what-is-ethereum/" style={{ color: '#007bff' }}>What is a cryptocurrency?</a></strong> It will help you understand what a wallet is and other fundamental concepts in the crypto space like blockchain, token, network...
</div>
