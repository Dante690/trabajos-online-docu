...
![How to access my proposals sent to clients](/logo/mispropuestas.png "How to access my proposals sent to clients")
...
![How to review a proposal sent to the client](/logo/estadocandidatura1.png "How to review our proposal")
...
![How to view a proposal sent by the client](/logo/estadocandidatura2.png "The client has sent us a proposal")
...
![How to review the Client's proposal](/logo/estadocandidatura3.png "How to review the Client's proposal")
...
![How to approve a client's proposal](/logo/estadocandidatura4.png "How to approve a client's proposal")
...
![Deploy of the Escrow contract and deposit funds](/logo/estadocandidatura5.png "Deploy of the Escrow contract and deposit the funds")
...
![Successfully deployed contract and addresses](/logo/estadocandidatura6.png "Successfully deployed contract and its data")
...
![Check the project status if the client has deposited the funds](/logo/estadocandidatura7.png "Check the project status if the client has deposited the funds")
