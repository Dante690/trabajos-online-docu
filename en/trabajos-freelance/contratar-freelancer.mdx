...
Once we have posted our job offer on the platform, interested freelancers will start sending their proposals to collaborate on our project 📬. To review these proposals, it is necessary to access the **"My Jobs"** section in our account.

<img src="/logo/contratar1.png" alt="How to review the sent proposals from the home menu" title="How to review sent proposals"  />

Within **"My Jobs"** 📂, we will find a list of all the job offers we have posted. We can select the specific offer we wish to review; by pressing the **Review Proposals** button, we will be directed to the **Proposals** 📃 section, where all the proposals sent by freelancers for that particular job are displayed.

## Details of Freelance Proposals 📝

At this point, we can carefully examine each proposal, evaluating the credentials, previous experiences, and expectations of each freelancer 👓.  
...
- **Freelancer's Name**: 👤.
- **Ranking and Portfolio**: Evaluate the quality and previous experience of the freelancer through their ranking on the platform and examples of previous work ⭐.
- **Cover Letter**: This includes a brief presentation from the Freelancer about their interest in your project 📄.
- **Required Price**: Prior knowledge of the cost that the freelancer considers appropriate for the work 💲.
- **Job Completion Time**: Time estimates that the freelancer needs to complete the project ⏳.
- **Accepted Form of Payment**: Whether the freelancer prefers fiat currency or crypto 💸💰. In case the Freelancer has registered a Wallet, the option of payment in cryptocurrencies will be shown.
...
This will allow us to select the proposal that best suits the needs and requirements of our project, thus ensuring a successful collaboration 🤝.

## Preliminary Communication before Selecting the Freelancer 💬
...
- **Specific Details of the Offer**: Make sure the freelancer fully understands what is expected of them in the project 📃.
- **Inquiries about Availability**: Verify if the freelancer is available to take on your project and what their working hours would be, especially if they are involved in other projects 📅.
...
Right next to the Chat button, you have the option to choose a freelancer, simply click on the **"Hire"** button ↪️. A window will open where you can select the payment method you wish to use to hire the freelancer.
