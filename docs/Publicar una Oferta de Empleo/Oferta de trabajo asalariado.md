...
- **Descripción del Puesto**: Ofrezca una descripción detallada que incluya responsabilidades, habilidades requeridas y cualquier otro detalle relevante. :memo:
...
- Empleado (Tiempo Completo, Tiempo Completo 100% Remoto) :office:
- Híbrido (% Remoto) :house_with_garden:
- Práctica :mortar_board:
- Voluntario :raised_hands:
- Otro (para casos específicos no contemplados en las categorías anteriores)

### Opciones Adicionales

- **Salario Anual**: Si lo desea, puede optar por publicar el rango salarial de la posición. :dollar:

- **Moneda de Pago**: Por defecto, la moneda establecida es el Euro (€), ofreciendo la flexibilidad de seleccionar otras monedas, como el Dólar Americano ($). :euro: :dollar:

# Categorías y Etiquetas de Trabajo :card_index_dividers:
...
Para las empresas ubicadas fuera de la Unión Europea :globe_with_meridians:, es importante tener en cuenta que **no se aplican los impuestos** como el IVA. En estos casos, se debe marcar la casilla correspondiente para indicar esta situación.
